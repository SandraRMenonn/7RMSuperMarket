...
public class LoginPage {
	...
	public HomePage clickSignIn() { 
		/*This is chaining of pages. We can use chaining for those scenarios where which we land in a different page after doing an action. 
		To chain we have do the return in the required landing page*/ 
		signInbutton.click();
	...
	/*public boolean isDashBoardDisplayed() { //For assertion
